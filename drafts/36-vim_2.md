...
TODO next:
1. Write a couple of snippets
2. Add them to home-manager (needs to live outside of neovim maybe?
3. Add them to `fromLua` config: [fromLua - nixvim docs](https://nix-community.github.io/nixvim/24.11/plugins/luasnip/fromLua.html)
